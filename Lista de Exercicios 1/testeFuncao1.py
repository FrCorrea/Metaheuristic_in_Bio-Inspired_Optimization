...
algoritmo_genetico = AG.AlgoritmoGenetico(-500, 500, -500, 500, 15, 10, 70, 50, 5, 0.7)
algoritmo_genetico.calcular_fitness("funcao_schwefel")
...
for i in range(algoritmo_genetico.num_geracoes):
    ...
    x_data += [mais_apto[0]]
    y_data += [mais_apto[1]]
    z_data += [algoritmo_genetico.retorna_custo(mais_apto, "funcao_schwefel")]
    nova_populacao = []
